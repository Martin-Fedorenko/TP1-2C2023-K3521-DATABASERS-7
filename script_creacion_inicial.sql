...
CREATE PROCEDURE DATABASERS.MIGRAR_INMUEBLE_X_CARACTERISTICA
AS
BEGIN
...
FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_WIFI = 1

SELECT DISTINCT INMUEBLE_CODIGO
FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_CABLE = 1

SELECT DISTINCT INMUEBLE_CODIGO
FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_CALEFACCION = 1

SELECT DISTINCT INMUEBLE_CODIGO
FROM gd_esquema.Maestra WHERE INMUEBLE_CARACTERISTICA_GAS = 1 
*/
...
CREATE PROCEDURE DATABASERS.MIGRAR_PAGO_VENTA
AS
BEGIN
