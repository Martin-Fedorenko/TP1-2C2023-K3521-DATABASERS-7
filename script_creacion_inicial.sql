...
ADD FOREIGN KEY (ALQUILER_ANUNCIO) REFERENCES DATABASERS.PAGO_ALQUILER(PAGO_ALQUILER_ALQUILER);

ALTER TABLE DATABASERS.ALQUILER 
ADD FOREIGN KEY (ALQUILER_INQUILINO) REFERENCES DATABASERS.INQUILINO(INQUILINO_PERSONA);
