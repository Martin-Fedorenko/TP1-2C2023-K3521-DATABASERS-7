...
DROP PROC CREAR_TABLAS, AGREGAR_FK
...
CREATE PROCEDURE MIGRAR_MONEDA --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_TIPO_INMUEBLE --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_ESTADO_INMUEBLE --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_CANT_AMBIENTES_INMUEBLE --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_DISPOSICION_INMUEBLE --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_ORIENTACION_INMUEBLE --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_ESTADO_ANUNCIO --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_TIPO_OPERACION_ANUNCIO --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_TIPO_PERIODO_ANUNCIO --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_ESTADO_ALQUILER --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_BARRIO --DONE
AS 
BEGIN 
...
CREATE PROCEDURE MIGRAR_LOCALIDAD --DONE
AS 
BEGIN 
...
CREATE PROCEDURE MIGRAR_PROVINCIA --DONE
AS 
BEGIN 
...
CREATE PROCEDURE MIGRAR_MEDIO_PAGO --DONE
AS 
BEGIN 
...
CREATE PROCEDURE MIGRAR_PERSONA --DONE
AS
BEGIN
...
CREATE PROCEDURE MIGRAR_VENTA --sobre venta_comprador falta venta_moneda
AS
BEGIN
