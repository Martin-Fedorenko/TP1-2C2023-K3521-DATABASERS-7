...
ALTER TABLE DATABASERS.BARRIO
ADD FOREIGN KEY (BARRIO_LOCALIDAD) REFERENCES DATABASERS.LOCALIDAD(LOCALIDAD_CODIGO);

ALTER TABLE DATABASERS.LOCALIDAD
ADD FOREIGN KEY (LOCALIDAD_PROVINCIA) REFERENCES DATABASERS.PROVINCIA(PROVINCIA_CODIGO);
