...
-- EJECUTAR DESDE ACÁ SI EL ESQUEMA FUE CREADO

EXECUTE DATABASERS.ELIMINAR_TABLAS --EJECUTAR HASTA QUE NO DE MÁS ERROR
EXECUTE DATABASERS.ELIMINAR_PROCEDIMIENTOS
EXECUTE DATABASERS.ELIMINAR_CREAR_TABLAS
...
-- ELIMINO CREAR TABLAS Y AGREGAR FK ANTERIORES
...
SELECT * FROM DATABASERS.DETALLE
SELECT * FROM DATABASERS.MONEDA
SELECT * FROM DATABASERS.PAGO_VENTA

SELECT INMUEBLE_CODIGO, COUNT(*) FROM DATABASERS.INMUEBLE 
JOIN DATABASERS.BARRIO ON INMUEBLE_BARRIO = BARRIO_CODIGO 
JOIN DATABASERS.LOCALIDAD ON LOCALIDAD_CODIGO = BARRIO_LOCALIDAD 
GROUP BY INMUEBLE_CODIGO, BARRIO_DETALLE, LOCALIDAD_DETALLE
ORDER BY 2 DESC

SELECT * FROM DATABASERS.
