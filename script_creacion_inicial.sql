...
/*CREATE TABLE DATABASERS.ANUNCIO(
	 NUMERIC(19,0) IDENTITY PRIMARY KEY NOT NULL,
	 NUMERIC(18,0) NULL,
	 DATETIME NULL,
	 NUMERIC(18,2) NULL,
	 NUMERIC(18,2) NULL,
...
BEGIN
	...
	SELECT ANUNCIO_CODIGO, INMUEBLE_CODIGO, ANUNCIO_FECHA_PUBLICACION, ANUNCIO_PRECIO_PUBLICADO,
	ANUNCIO_COSTO_ANUNCIO, ANUNCIO_FECHA_FINALIZACION,TIPO_OPERACION_CODIGO, MONEDA_CODIGO,
	ESTADO_ANUNCIO_CODIGO, TIPO_PERIODO_CODIGO, SUCURSAL_CODIGO, PERSONA_CODIGO
	FROM gd_esquema.Maestra
END
GO

SELECT * FROM DATABASERS.PERSONA JOIN DATABASERS.AGENTE ON PERSONA_CODIGO = AGENTE_PERSONA
...
SELECT distinCT * FROM DATABASERS.INMUEBLE