...
JOIN DATABASERS_BI.BI_TIEMPO T2 ON T2.BI_TIEMPO_CODIGO=A2.ALQUILER_TIEMPO
...
GROUP BY T2.BI_TIEMPO_ANIO,T2.BI_TIEMPO_MES))/COUNT(P1.PAGO_ALQUILER_CODIGO) FROM DATABASERS_BI.BI_ALQUILER A1
...
CREATE VIEW DATABASERS_BI.INCREMENTO_ALQUILER
AS
SELECT (100*(P1.BI_PAGO_ALQUILER_IMPORTE-(SELECT P2.BI_PAGO_ALQUILER_IMPORTE FROM DATABASERS_BI.BI_ALQUILER A2
JOIN DATABASERS_BI.BI_PAGO_ALQUILER P2 ON P2.BI_PAGO_ALQUILER_ALQUILER=A2.BI_ALQUILER_CODIGO 
JOIN DATABASERS_BI.BI_TIEMPO T2 ON T2.BI_TIEMPO_CODIGO=A2.ALQUILER_TIEMPO
WHERE T2.BI_TIEMPO_MES=T1.BI_TIEMPO_MES-1)))/(SELECT P2.BI_PAGO_ALQUILER_IMPORTE FROM DATABASERS_BI.BI_ALQUILER A2
JOIN DATABASERS_BI.BI_PAGO_ALQUILER P2 ON P2.BI_PAGO_ALQUILER_ALQUILER=A2.BI_ALQUILER_CODIGO 
JOIN DATABASERS_BI.BI_TIEMPO T2 ON T2.BI_TIEMPO_CODIGO=A2.ALQUILER_TIEMPO
WHERE T2.BI_TIEMPO_MES=T1.BI_TIEMPO_MES-1) FROM DATABASERS_BI.BI_ALQUILER A1 JOIN DATABASERS_BI.BI_ESTADO_ALQUILER E1 ON E1.BI_ESTADO_ALQUILER_CODIGO=A1.BI_ALQUILER_ESTADO 
JOIN DATABASERS_BI.BI_PAGO_ALQUILER P1 ON P1.BI_PAGO_ALQUILER_ALQUILER=A1.BI_ALQUILER_CODIGO
JOIN DATABASERS_BI.BI_TIEMPO T1 ON T1.BI_TIEMPO_CODIGO=A1.BI_ALQUILER_TIEMPO
WHERE P1.BI_PAGO_ALQUILER_IMPORTE> (SELECT P3.BI_PAGO_ALQUILER_IMPORTE FROM DATABASERS_BI.BI_ALQUILER A3
JOIN DATABASERS_BI.BI_PAGO_ALQUILER P3 ON P3.BI_PAGO_ALQUILER_ALQUILER=A3.BI_ALQUILER_CODIGO 
JOIN DATABASERS_BI.BI_TIEMPO T3 ON T3.BI_TIEMPO_CODIGO=A3.ALQUILER_TIEMPO
