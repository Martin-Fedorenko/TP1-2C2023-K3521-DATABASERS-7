...
-- VISTA 1
CREATE VIEW DATABASERS.PROM_DIAS_PUBLICACION --revisada
AS
...
-- VISTA 2
CREATE VIEW DATABASERS.PROM_PRECIO_ANUNCIO -- revisada
AS
...
--VISTA 3
CREATE VIEW DATABASERS.MEJORES_BARRIOS -- revisada
AS
...
-- VISTA 5 
CREATE VIEW DATABASERS.INCREMENTO_ALQUILER -- revisada
AS
	SELECT CONCAT(
	...
	WHERE BI_ESTADO_ALQUILER_DETALLE = 'Activo'
	GROUP BY BI_TIEMPO_ANIO, BI_TIEMPO_MES, BI_ESTADO_ALQUILER_DETALLE
GO

-- VISTA 6
CREATE VIEW DATABASERS.PROM_PRECIO_M2_VENTAS --revisada
AS
...
--VISTA 9
CREATE VIEW DATABASERS.MONTO_TOTAL_CIERRE_CONTRATOS_POR_TIPO_OP --revisada
AS
