...
CREATE VIEW DATABASERS.PORCENTAJE_INCUMPLIMIENTO -- no revisada
AS
...
AS
	SELECT BI_SUCURSAL_NOMBRE, BI_RANGO_ETARIO_DETALLE, BI_TIPO_OPERACION_DETALLE, BI_TIEMPO_ANIO, CAST((100 * SUM(CAST(BI_ANUNCIO_OP_CONCRETADA AS DECIMAL)) / SUM(BI_ANUNCIO_CANTIDAD_ANUNCIOS)) AS DECIMAL(12,2)) AS PORCENTAJE
	FROM DATABASERS.BI_ANUNCIO
		JOIN DATABASERS.BI_SUCURSAL ON BI_ANUNCIO_SUCURSAL = BI_SUCURSAL_CODIGO
		JOIN DATABASERS.BI_TIEMPO ON BI_ANUNCIO_TIEMPO = BI_TIEMPO_CODIGO
