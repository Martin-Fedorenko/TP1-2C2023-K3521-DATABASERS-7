...
AS
SELECT TOP 5 BI_ALQUILER_BARRIO, BI_TIEMPO_ANIO, BI_TIEMPO_CUATRIMESTRE FROM DATABASERS.BI_ALQUILER
...
SELECT BI_SUCURSAL_NOMBRE, BI_RANGO_ETARIO_DETALLE, BI_TIEMPO_ANIO, COUNT(*)* 100.0 /(SELECT COUNT(*)
