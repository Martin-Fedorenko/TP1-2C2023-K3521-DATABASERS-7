...
BEGIN
	...
	GROUP BY BI_TIEMPO_CODIGO, BI_TIEMPO_ANIO, BI_TIEMPO_CUATRIMESTRE, ANUNCIO_TIPO_OPERACION, BI_UBICACION_CODIGO, INMUEBLE_CANT_AMBIENTES, ANUNCIO_SUCURSAL, INMUEBLE_TIPO_INMUEBLE, ANUNCIO_MONEDA, DATABASERS.OBTENER_RANGO_SUPERFICIE(INMUEBLE_SUPERFICIETOTAL),  DATABASERS.OBTENER_RANGO_ETARIO(PERSONA_FECHA_NAC, GETDATE()), ANUNCIO_ESTADO
	...
	SELECT BI_TIEMPO_CODIGO, ANUNCIO_ESTADO, ANUNCIO_TIPO_OPERACION, INMUEBLE_BARRIO, INMUEBLE_CANT_AMBIENTES, ANUNCIO_SUCURSAL, --4055
	INMUEBLE_TIPO_INMUEBLE, ANUNCIO_MONEDA, DATABASERS.OBTENER_RANGO_SUPERFICIE(INMUEBLE_SUPERFICIETOTAL),
	DATABASERS.OBTENER_RANGO_ETARIO(PERSONA_FECHA_NAC, GETDATE()), SUM(DATEDIFF(DAY, ANUNCIO_FECHA_PUBLICACION, ANUNCIO_FECHA_FINALIZACION)),
	...
	SELECT BI_TIEMPO_CODIGO, ANUNCIO_ESTADO, ANUNCIO_TIPO_OPERACION, INMUEBLE_BARRIO, INMUEBLE_CANT_AMBIENTES, ANUNCIO_SUCURSAL, --11506
	INMUEBLE_TIPO_INMUEBLE, ANUNCIO_MONEDA, DATABASERS.OBTENER_RANGO_SUPERFICIE(INMUEBLE_SUPERFICIETOTAL),
	DATABASERS.OBTENER_RANGO_ETARIO(PERSONA_FECHA_NAC, GETDATE()), SUM(DATEDIFF(DAY, ANUNCIO_FECHA_PUBLICACION, ANUNCIO_FECHA_FINALIZACION)),
...
AS
	SELECT BI_SUCURSAL_NOMBRE, BI_RANGO_ETARIO_DETALLE, BI_TIPO_OPERACION_DETALLE, BI_TIEMPO_ANIO, CAST(100 * SUM(BI_ANUNCIO_OP_CONCRETADA) / BI_ANUNCIO_CANTIDAD_ANUNCIOS AS DECIMAL) AS PORCENTAJE
	FROM DATABASERS.BI_ANUNCIO
		JOIN DATABASERS.BI_SUCURSAL ON BI_ANUNCIO_SUCURSAL = BI_SUCURSAL_CODIGO
		JOIN DATABASERS.BI_TIEMPO ON BI_ANUNCIO_TIEMPO = BI_TIEMPO_CODIGO
