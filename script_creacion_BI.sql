...
BEGIN
	...
	VALUES (YEAR(@FECHA), DATEPART(QUARTER, @FECHA), MONTH(@FECHA))
...
BEGIN
	INSERT INTO DATABASERS.BI_TIEMPO 
	(BI_TIEMPO_ANIO, BI_TIEMPO_CUATRIMESTRE, BI_TIEMPO_MES)
	SELECT DISTINCT YEAR(ANUNCIO_FECHA_PUBLICACION), DATEPART(QUARTER, ANUNCIO_FECHA_PUBLICACION), MONTH(ANUNCIO_FECHA_PUBLICACION) FROM DATABASERS.ANUNCIO
	UNION (SELECT DISTINCT YEAR(VENTA_FECHA), DATEPART(QUARTER, VENTA_FECHA), MONTH(VENTA_FECHA) FROM DATABASERS.VENTA)
...
BEGIN
	...
	(BI_ANUNCIO_TIEMPO, BI_ANUNCIO_TIPO_OPERACION, BI_ANUNCIO_BARRIO, BI_ANUNCIO_AMBIENTES_INMUEBLE, BI_ANUNCIO_SUCURSAL, BI_ANUNCIO_TIPO_INMUEBLE, BI_ANUNCIO_MONEDA,  BI_ANUNCIO_RANGO_SUPERFICIE, BI_ANUNCIO_RANGO_ETARIO, BI_ANUNCIO_DIAS_PUBLICADO, BI_ANUNCIO_COMISION)
	SELECT DISTINCT BI_TIEMPO_CODIGO, ANUNCIO_TIPO_OPERACION, INMUEBLE_BARRIO, INMUEBLE_CANT_AMBIENTES, ANUNCIO_SUCURSAL, INMUEBLE_TIPO_INMUEBLE, ANUNCIO_MONEDA, DATABASERS.OBTENER_RANGO_SUPERFICIE(INMUEBLE_SUPERFICIETOTAL),  DATABASERS.OBTENER_RANGO_ETARIO(PERSONA_FECHA_NAC, ANUNCIO_FECHA_PUBLICACION), AVG(DATEDIFF(DAY, ANUNCIO_FECHA_PUBLICACION, ANUNCIO_FECHA_FINALIZACION))
	...
	GROUP BY BI_TIEMPO_CODIGO, ANUNCIO_TIPO_OPERACION, INMUEBLE_BARRIO, INMUEBLE_CANT_AMBIENTES, ANUNCIO_SUCURSAL, INMUEBLE_TIPO_INMUEBLE, ANUNCIO_MONEDA, INMUEBLE_SUPERFICIETOTAL, PERSONA_FECHA_NAC, ANUNCIO_FECHA_PUBLICACION

END
GO

select * from DATABASERS.ANUNCIO
...
INSERT INTO DATABASERS.BI_VENTA
	...
	DATABASERS.OBTENER_RANGO_ETARIO(PERSONA_FECHA_NAC,GETDATE()),
...
SET @NACIMIENTO= (SELECT PERSONA_FECHA_NAC FROM PERSONA
JOIN DATABASERS.INQUILINO ON PERSONA_CODIGO=INQUILINO_PERSONA
 JOIN DATABASERS.ALQUILER ON INQUILINO_ALQUILER=INQUILINO_ALQUILER
 WHERE ALQUILER_CODIGO=@ALQUILER_CODIGO)
SET @FECHA_PAGO= (SELECT PAGO_ALQUILER_FECHA FROM PAGO_ALQUILER JOIN ALQUILER ON PAGO_ALQUILER_ALQUILER=ALQUILER_CODIGO
WHERE ALQUILER_CODIGO=@ALQUILER_CODIGO)
SET @RANGO_ETARIO=0
SET @FK_BI_TIEMPO=0
EXEC DATABASERS.GENERAR_BI_TIEMPO @FECHA=@FECHA_PAGO, @PK=@FK_BI_TIEMPO OUTPUT
EXEC DATABASERS.OBTENER_RANGO_ETARIO @FECHA_NAC=@NACIMIENTO,@FECHA=PAGO_ALQUILER_IMPORTE,@RANGO=@RANGO_ETARIO OUTPUT
INSERT INTO DATABASERS.BI_ALQUILER(
	BI_ALQUILER_CODIGO,BI_ALQUILER_PAGO_CODIGO,BI_ALQUILER_BARRIO BI_ALQUILER_TIEMPO, BI_ALQUILER_RANGO_ETARIO,
	BI_ALQUILER_INCUMPLIMIENTO, BI_ALQUILER_INCREMENTO
) 
SELECT DISTINCT ALQUILER_CODIGO,PAGO_ALQUILER_CODIGO,INMUEBLE_BARRIO,@FK_BI_TIEMPO,@RANGO_ETARIO,
...
SELECT * FROM DATABASERS.BI_ANUNCIO
