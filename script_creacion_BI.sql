...
CREATE TABLE DATABASERS.BI_ANUNCIOS(
	...
	BI_RANGO_SUPERFICIE_CODIGO INTEGER NOT NULL,
	BI_TIPO_INMUEBLE NUMERIC (18,0) NOT NULL,
...
ALTER TABLE DATABASERS.BI_ALQUILER
ADD FOREIGN KEY (BI_ALQUILER_CODIGO) REFERENCES DATABASERS.BI_PAGO_ALQUILER(BI_PAGO_ALQUILER_ALQUILER); 
