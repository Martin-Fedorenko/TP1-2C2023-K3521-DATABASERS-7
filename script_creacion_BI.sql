...
-- VISTA 1
CREATE VIEW DATABASERS.PROM_DIAS_PUBLICACION --revisado
AS
...
--VISTA 3
CREATE VIEW DATABASERS.MEJORES_BARRIOS -- no revisada
AS
...
--VISTA 8
CREATE VIEW DATABASERS.PORCENTAJE_OPERACIONES_CONCRETADAS -- falta revisar
AS
...
--VISTA 9
CREATE VIEW DATABASERS.MONTO_TOTAL_CIERRE_CONTRATOS_POR_TIPO_OP --revisado
AS
