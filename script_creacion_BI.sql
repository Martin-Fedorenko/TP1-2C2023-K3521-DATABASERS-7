...
BEGIN 
	...
	SELECT DISTINCT INMUEBLE_BARRIO,BI_TIEMPO_CODIGO, (EXEC DATABASERS.OBTENER_RANGO_ETARIO @FECHA_NAC=PERSONA_FECHA_NAC, @FECHA=PAGO_ALQUILER_FECHA, @RANGO=@RANGO_ETARIO OUTPUT)
